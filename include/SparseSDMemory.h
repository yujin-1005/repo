...
private:
    ...
    unsigned int R;   //yujin: number of rows in the mapping_table 
...
public:
    ...
    ~SparseSDMemory();
    void setLayer(DNNLayer* dnn_layer,  address_t KN_address, address_t MK_address, metadata_address_t mapping_table, address_t output_address, Dataflow dataflow);
