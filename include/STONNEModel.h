...
public:
   ...
   //Load CONV Layer. At the end this calls to the general constructor  with all the parameters
    ...
    void loadGEMM(std::string layer_name, unsigned int N, unsigned int K, unsigned int M, address_t MK_matrix, address_t KN_matrix, metadata_address_t mapping_table, address_t output_matrix, Dataflow dataflow);
