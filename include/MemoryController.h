...
public:
    ...
    virtual void setLayer(DNNLayer* dnn_layer,  address_t input_address, address_t filter_address, metadata_address_t mapping_table, address_t output_address, Dataflow dataflow) {assert(false);}
